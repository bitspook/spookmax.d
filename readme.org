    ...
    (use-package org-super-agenda
      ...
      (setq org-super-agenda-groups
            '((:name "Work" :tag "work" :order 1)
              ...
              (:name "Health" :tag "health" :order 5)
...
#+begin_src elisp
  (when (file-exists-p "/gnu/store/")
    ...
    (use-package geiser-guile
      ...
      (add-to-list 'auto-mode-alist '("\\.scm\\'" . geiser-devel-mode))))
#+end_src
...
- My workflows
  ...
  #+begin_src elisp
    (dolist (file (directory-files default-directory t "workflow-.*\\.el"))
      (load-file file))
  #+end_src
