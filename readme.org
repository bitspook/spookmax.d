...
- Allow adding HTML class/id to exported src blocks
  ...
  #+begin_src elisp
    ;; Copied from https://emacs.stackexchange.com/questions/68592/add-css-class-or-id-tag-to-individual-src-blocks

    (defun spook--org-html-src-block-advice (oldfun src-block contents info)
    ...
    (advice-add 'org-html-src-block :around #'spook--org-html-src-block-advice)
  #+end_src
