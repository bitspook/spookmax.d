...
- Marginalia adds pretty information to completions. I am adding it because
  they're pretty, and I imagine will be helpful. If they're not, I'll remove it
  later.
...
- Orderless adds matches completion candidates by space-separated patterns in
  any order. I liked this style of matching in Spacemacs a lot, and miss it in
  ivy

  #+begin_src elisp
    (use-package orderless
      :config
      (setq completion-styles '(orderless-regexp)))
  #+end_src
