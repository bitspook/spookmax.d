...
- Bootstrap
  ...
  #+begin_src elisp :tangle ./early-init.el
    ...
    (defun my--use-package-ensure (pkg args state)
      (if (assoc 'powered-by-guix my--feature-flags) nil
...
- Completions
  ...
  #+begin_src elisp
    ;; (require 'company)
    ;; (with-eval-after-load 'company (global-company-mode +1))
