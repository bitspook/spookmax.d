  ...
  #+begin_src elisp
    (setq
     ...
     org-agenda-files (list org-inbox-file
                            ...
                            (expand-file-name "reading-list.org" org-directory))
...
- Agenda from denotes
  ...
  #+begin_src elisp
    ...
    (defun my-update-agenda-denotes ()
      ...
      (cl-dolist (id (mapcar #'denote-extract-id-from-string (my--denote-files-with-tags '("todo"))))
        (add-to-list 'org-agenda-files (denote-get-path-by-id id))))

    (eval-after-load 'denote #'my-update-agenda-denotes)
  #+end_src
