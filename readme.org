...
- Profiles
  ...
  #+begin_src elisp
    ...
    (defvar spook--monitors (split-string (s-replace-regexp "[\+\*]*" "" (eshell-command-result "xrandr --listmonitors | cut -d \" \" -f 3")) "[\n]" t nil)
      "List of available monitors.")

    (when (s-contains-p "kajal" (system-name))
...
- Font size
  ...
  #+begin_src elisp
    ...
    (when (seq-contains-p spook--active-profiles 'small-screen)
