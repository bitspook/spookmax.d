...
- spookfox
  ...
  #+begin_src elisp
    (when (file-exists-p "~/Documents/work/spookfox")
      ...
      (define-key spook-buffers-keymap (kbd "t") #'spookfox-switch-tab))
  #+end_src
...
- Irc
  ...
  #+begin_src elisp
    (setf erc-autojoin-channels-alist '(("libera.chat" "#commonlisp" "#emacs" "#clschool" "#whereiseveryone" "#lispcafe")))
    ...
    (defun spook-erc-connect ()
      ...
      (erc :server "irc.libera.chat"
           :port 6667
           :nick "bitspook"
           :password (auth-source-pass-get 'secret "libera.chat/bitspook")))
  #+end_src
