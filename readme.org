...
- UI fixes copied from Doom
  ...
  - Minibuffer
    ...
    #+begin_src elisp
      ...
      ;; there is a variable for this (setq use-short-answers t)
...
- Introspection
  ...
  that really should land in vanila emacs
  #+begin_src elisp
...
;; properties do allow them. hmmm. I don't remember why I did allow hem - but surely enough I did. 
;; I also have used IN-PROGRESS but this todo status can't be search in agenda.
...
nice, im stil stuck with paredit
#+begin_src elisp
  (use-package lispy
...
- Azure cloud
  ...
  #+begin_src elisp
    (when (file-exists-p (expand-file-name "~/Documents/work/ecloud"))
      (use-package ecloud
        :straight (ecloud :type git
                          :local-repo "~/Documents/work/ecloud")))
  #+end_src
